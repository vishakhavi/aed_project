...
public class ThriftDealer {
    ...
    public ThriftDealer(String name, EcoSystem system) {
        id = count;
        this.name = name;
        ...
        this.userAccountAssoc = system.getUserAccountDirectory().createUserAccount(name.replaceAll("\\s", ""), "dealerAdmin", employee, new ManufacturerAdminRole());
