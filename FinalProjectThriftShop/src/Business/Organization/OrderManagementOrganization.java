...
public class OrderManagementOrganization extends Organization{
    ...
    public OrderManagementOrganization(String name, EcoSystem system) {
        ...
        this.userAccountAssoc = system.getUserAccountDirectory().createUserAccount(name.replaceAll("\\s", ""), "admin", employee, new OrderManagementRole());
