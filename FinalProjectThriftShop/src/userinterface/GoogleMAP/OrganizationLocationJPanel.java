...
public class OrganizationLocationJPanel extends javax.swing.JPanel {
    ...
    private void setLocationBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_setLocationBtnActionPerformed
        ...
        try {
            ...
            if (userProcessContainer.getComponent(componentArray.length - 1) instanceof PostAdJPanel) {
                PostAdJPanel postAdJPanel = (PostAdJPanel) userProcessContainer.getComponent(componentArray.length - 1);
                postAdJPanel.populateLongituteLatitude(locationPoint);
