 ...
 * @author Vishakha
 */
public class ManufacturerOrderDetailsJPanel extends javax.swing.JPanel {
    ...
    UserAccount account;
    public ManufacturerOrderDetailsJPanel(JPanel userProcessContainer,EcoSystem ecosystem, UserAccount account) {
        initComponents();
       // initListners();
     ...
     private void populatRestaurantRequestTable(){
        ...
        model.setRowCount(0);
        workRequestList = ecosystem.getWorkQueue().getWorkRequestListManufacturer(account);
            ...
            public void valueChanged(ListSelectionEvent event) {
                ...
                if (selectedRow >= 0) {
                    ...
                    if (request instanceof WorkOrderRequest) {
                        WorkOrderRequest orderWorkRequest = (WorkOrderRequest) tblRestaurantWorkRequest.getValueAt(selectedRow, 0);
